...
public class AstronautCassandraDAL {
    ...
    protected record AstronautMission(
        String missionName, Instant startDate, Instant endDate, String astronautName) {
    }

    public AstronautCassandraDAL(
        String host, String port, String keyspace, String localDatacenter) {
        
        cassandra = new CassandraConn(host, port, keyspace, localDatacenter);
    }
