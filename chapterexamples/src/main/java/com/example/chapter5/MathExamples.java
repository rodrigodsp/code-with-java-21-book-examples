...
public class MathExamples {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%1.3f", 5.234567);

    }
    
    public static int add(int intNumA, int intNumB) {
        return intNumA + intNumB;
    }

    public static double add(double dblNumC, double dblNumD) {
    ...
    public static int subtract(int intNumA, int intNumB) {
        return intNumA - intNumB;
    }
    ...
    public static int multiply(int intNumA, int intNumB) {
        return intNumA * intNumB;
    }
